<?php
class News_action_textpicCenteredRight_f52200c4606dccf4 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
return $renderingContext->getVariableProvider()->getByPath('settings.responsiveimages.contentelements.textpic.centered_right');
};
