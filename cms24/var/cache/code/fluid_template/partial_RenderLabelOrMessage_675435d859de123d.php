<?php
class partial_RenderLabelOrMessage_675435d859de123d extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array5 = [
'0' => $renderingContext->getVariableProvider()->getByPath('settings.{key}'),
];
...
$output7 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('settings.{key}')]);
